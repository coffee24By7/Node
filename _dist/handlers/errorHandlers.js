...
exports.flashValidationErrors = function (err, req, res, next) {
    ...
    errorKeys.forEach(function (key) { return req.flash('error', err.errors[key].message); });
    res.redirect('back');
};
/*
...
exports.developmentErrors = function (err, req, res, next) {
    ...
    res.format({
        ...
        'application/json': function () { return res.json(errorDetails); } // Ajax call, send JSON back
    });
};
/*
